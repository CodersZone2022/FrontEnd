...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  CameraPosition _cameraPosition =
      const CameraPosition(target: LatLng(22.978624, 87.747803), zoom: 17);
  late LatLng _initialPosition = LatLng(22.978624, 87.747803);
    ...
    return Scaffold(
      ...
      body: GetBuilder<UserController>(builder: (userController) {
        if (_contactPersonName.text.isEmpty) {
          ...
          _contactPersonNumber.text = '${userController.userModel.contuct}';
          if (Get.find<LocationController>().addressList.isNotEmpty) {
            _addressController.text =
                Get.find<LocationController>().getUserAddress().adderss;
          }
        }
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(
                      left: Dimensions.widht20, top: Dimensions.height20),
                  child: SizedBox(
                    height: 50,
                ...
                Padding(
                  padding: EdgeInsets.only(left: Dimensions.widht20),
